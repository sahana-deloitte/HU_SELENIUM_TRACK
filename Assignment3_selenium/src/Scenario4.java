...
import java.io.IOException;
    ...
    public class Scenario4 {
        ...
        private static void launchUrl(WebDriver driver) throws InterruptedException {
            ...
            try {
                FileUtils.copyFile(src, new File("src/Screenshot.png"));
            } catch (IOException e) {
                e.printStackTrace();
            }
            Thread.sleep(2000);
        ...
        public static void Scenario4exe(WebDriver driver) throws InterruptedException {
            ...
            Thread.sleep(2000);
            JavascriptExecutor js = (JavascriptExecutor) driver;
            js.executeScript("document.getElement(By.xpath('//*[@id=\"root\"]/div/div[2]/div[2]/div/div[1]/div[1]/div/div/p)).value='New York'");
        }
    }
